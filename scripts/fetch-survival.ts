 ...
 *     distant, unknown), when the site has one (haematologic indications do not);
 ...
 * survival is a US population statistic and that several Nuclide indications share one SEER site.
 *
