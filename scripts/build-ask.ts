/**
 * Builds the Ask Nuclide name index (src/lib/ask-index.ts): one entry per record with id, kind, name, aliases,
...
const smokeQ = "What is theranostics and what is the best-known example?";
