...
const UA = "Nuclide DOI checker (+https://github.com/casadesante/Nuclide)";
...
const STOP = new Set(("a an and or of the in for with without to on at by from as is are was were be been vs versus than " +
  "cancer indications tumor tumors tumour tumours oncology oncologic neoplasm neoplasms malignant malignancy malignancies " +
