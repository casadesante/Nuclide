 ...
 * naming Nuclide, retries with backoff. Resumable: ids fetched (or checked) under 30 days ago are skipped
 * unless --force.
 *
...
const UA = "Nuclide portrait fetcher/1.0 (https://github.com/casadesante/Nuclide; contact via GitHub issues)";
...
const STOP = new Set(["with", "whose", "that", "this", "from", "into", "their", "were", "have", "been", "which", "about", "after", "over", "into", "chief", "head", "director", "professor", "president", "former", "senior", "lead", "leader", "programme", "program", "division", "department", "service", "center", "centre", "indication", "medical", "oncology", "medicine"]);
