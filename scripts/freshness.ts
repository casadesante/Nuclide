...
export const TRACK_META: Record<Track, { label: string; owner: string }> = {
  clinical: { label: "Expert (clinical)", owner: "Indication pages, standard-of-care rows, trial outcomes" },
...
export const SLAS: Sla[] = [
  ...
  { id: "indications", label: "Indication pages", track: "clinical", days: 180, critical: true, applies: (e) => e.kind === "indication" },
