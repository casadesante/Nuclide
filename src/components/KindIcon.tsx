...
const ICONS: Record<Kind, (p: P) => React.ReactElement> = {
  indication: (p) => <Svg {...p}><path d="M12 3c4.5 0 8 3.6 8 8.2 0 4.8-3.8 9.8-8 9.8S4 16 4 11.2C4 6.6 7.5 3 12 3Z" /><circle cx="10" cy="10" r="2.2" /><circle cx="14.5" cy="14" r="1.2" fill="currentColor" stroke="none" /></Svg>,
  ...
  isotope: (p) => <Svg {...p}><circle cx="12" cy="12" r="2" fill="currentColor" stroke="none" /><ellipse cx="12" cy="12" rx="9" ry="4" /><ellipse cx="12" cy="12" rx="9" ry="4" transform="rotate(60 12 12)" /><ellipse cx="12" cy="12" rx="9" ry="4" transform="rotate(120 12 12)" /></Svg>,
