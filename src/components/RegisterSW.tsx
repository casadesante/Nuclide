      ...
      <div className="pointer-events-auto card shadow-pop px-4 py-2.5 text-sm flex flex-wrap items-center gap-3 max-w-xl" role="status" aria-live="polite">
        {offline ? (
          ...
          <>
            ...
            <span>A new version of Nuclide is ready.</span>
