 ...
 * tagged nuclide.cc, in a new tab; Nuclide itself never receives it. With no provider configured the box says so instead
 * of pretending to save the address. Accounts are not here: they live on the signed-in site, me.nuclide.cc.
 */
export function SignupForm() {
  ...
  return (
    <form action={ACTION} method="post" target="_blank" onSubmit={() => setSent(true)} className="card p-5 space-y-3">
      ...
      <input type="hidden" name="tag" value="nuclide.cc" />
