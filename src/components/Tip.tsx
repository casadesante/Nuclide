...
export const COLUMN_TIPS: Record<string, string> = {
  ...
  Fronts: "The broad areas of the field this belongs to: molecular imaging, radioligand therapy, isotope supply, dosimetry, and so on.",
  Front: "The broad area of the field this belongs to.",
  ...
  Group: "The broad family of indication: solid tumour, blood cancer, brain, skin, and so on.",
