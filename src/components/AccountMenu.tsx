...
/**
 * The "Sign in/up" control in the header: a bridge to the signed-in site. nuclide.cc is the public, signed-out site
 * and stores nothing personal, neither in the browser nor in any cloud; roles, cancer type and case data live at
 * https://me.nuclide.cc/, a separate app with its own sign-in and database. This control is a plain anchor to that
 * site carrying the current nuclide.cc address as `?back=`, so the reader can come straight back to the page they
 ...
 */
export const ME_URL = "https://me.nuclide.cc/signin/";
