    ...
    <div className="print-header" aria-hidden data-mode={mode}>
      <div className="print-header-row">
        <div className="print-header-text">
          <div className="print-header-brand">Nuclide <span>nuclide.cc</span></div>
          <div className="print-header-title">{titleProp ?? (typeof document !== "undefined" ? document.title.replace(/ · Nuclide$/, "") : "")}</div>
