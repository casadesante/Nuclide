      ...
      <section aria-labelledby="h-watch">
        ...
        {!ready ? <p className="text-sm text-muted">Loading…</p> : watching.length === 0 ? (
          <div className="card p-5 text-sm text-muted">
            ...
            <p className="mt-2">Try <Link className="underline" href="/drugs/trastuzumab-deruxtecan/">Enhertu</Link>, <Link className="underline" href="/indications/tnbc/">triple-negative breast cancer</Link> or <Link className="underline" href="/targets/trop2/">TROP2</Link>.</p>
          </div>
        ) : (
