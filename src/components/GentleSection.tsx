...
export const AVERAGES_NOTE = "These are averages across everyone diagnosed, often years ago. Stage, subtype, age, fitness and the treatment received matter more than the average, and for many indications the numbers are improving quickly.";
