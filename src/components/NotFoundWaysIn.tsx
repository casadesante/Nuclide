  ...
  return (
    <>
      <section aria-labelledby="nf-search">
        <h2 id="nf-search" className="text-lg font-semibold tracking-tight mb-3 inline-flex items-center gap-2"><NavIcon id="search" className="h-5 w-5 text-accent" />Search Nuclide</h2>
        <SearchBox large />
      </section>
