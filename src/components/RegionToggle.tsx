...
export function RegionToggle() {
  ...
  return (
    <div ref={box} className="relative flex items-center">
      <button type="button" data-nuclide-toggle="region" onClick={() => setOpen((o) => !o)} aria-haspopup="listbox" aria-expanded={open} aria-label={t("region.aria", { region: meta.label })} title={t("region.title", { region: meta.label, regulator: meta.regulator })}
