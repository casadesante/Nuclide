...
export const SURVIVAL_SITES: Record<string, SurvivalSite> = {
  ...
  cholangiocarcinoma: { slug: "livibd", seerLabel: "Liver and intrahepatic bile duct", shared: "SEER combines intrahepatic bile duct cancer with liver cancer; extrahepatic and gallbladder indications are not included." },
  prostate: { slug: "prost", seerLabel: "Prostate" },
  urothelial: { slug: "urinb", seerLabel: "Urinary bladder", shared: "Upper-tract urothelial indications are not included in the bladder site." },
  ...
  osteosarcoma: { slug: "bones", seerLabel: "Bone and joint", shared: "SEER combines all bone and joint indications." },
  "ewing-sarcoma": { slug: "bones", seerLabel: "Bone and joint", shared: "SEER combines all bone and joint indications." },
...
export const INTERNATIONAL_SOURCES = [
  { label: "CNUCLIDERD-3: global surveillance of trends in cancer survival 2000-14 (Lancet, 2018)", url: "https://doi.org/10.1016/S0140-6736(17)33326-3", note: "Five-year net survival for 18 indications in 71 countries, from 322 population-based registries." },
