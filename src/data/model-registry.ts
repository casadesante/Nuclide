...
export const models: ModelRecord[] = [
  ...
  { id: "virchow", modality: "histology", parametersM: 1900, trainingData: "Virchow: 1.5 million slides from MSK (632M parameters). Virchow2 and Virchow2G: 3.1 million slides from MSK and global sites at mixed magnification.", weights: "gated", licence: "CC BY-NC-ND 4.0 (Virchow2 model card)", benchmark: "Pan-cancer detection AUC 0.95 across 17 cancer types, including rare indications, in the Virchow paper.", paper: "10.1038/s41591-024-03141-0", weightsUrl: hf("paige-ai/Virchow2"), year: 2024 },
  ...
  { id: "chief", modality: "histology", trainingData: "Pretrained on 15 million tiles, then 60,530 slides; validated on 19,400 slides from 24 hospitals.", weights: "gated", licence: "AGPL-3.0 (code repository)", benchmark: "Indication detection accuracy up to 94% and improvement of about 36% over prior deep-learning methods on external cohorts (paper).", paper: "10.1038/s41586-024-07894-z", weightsUrl: gh("hms-dbmi/CHIEF"), datasets: ["tcga-gdc", "cptac"], year: 2024 },
  ...
  { id: "alphagenome", modality: "DNA", trainingData: "Human and mouse reference genomes with thousands of functional genomics tracks; 1 megabase input at single-base resolution.", weights: "gated", weightsUrl: "https://github.com/google-deepmind/alphagenome_research", licence: "Code Apache 2.0; model weights on Kaggle and Hugging Face under DeepMind non-commercial model terms", benchmark: "Matched or beat specialist models on 22 of 24 sequence prediction and 24 of 26 variant-effect tasks (DeepMind).", paper: "10.1038/s41586-025-09937-1", year: 2025 },
...
export const datasets: DatasetRecord[] = [
  ...
  { id: "cosmic", size: "Curated somatic mutations across millions of samples; Indication Gene Census of about 750 genes", modality: "DNA", access: "registered", consent: "Free academic registration; commercial licence." },
  ...
  { id: "hpa", size: "Protein expression across tissues, indications and single cells", modality: "histology", access: "open", consent: "CC BY-SA 4.0." },
];
