...
export const lungIndications: EntityInput[] = [
  {
    ...
    related: ["sclc", "lung-net", "f-18", "tc-99m", "ga-68", "pb-212-psv359", "pulmonary-embolism-vq", "split-function-lung-perfusion"],
    indications: ["sclc", "lung-net"],
    technologies: ["fdg-pet", "pet-ct", "ct", "spect-ct", "fapi-pet", "radiomics", "split-function-lung-perfusion"],
    targets: ["glut-hexokinase", "fap", "integrin-avb3"],
    drugs: ["fludeoxyglucose-f18", "pexiretide-tc99m", "ga-68-fapi-46", "f-18-fluorothymidine", "tc-99m-mdp", "tc-99m-maa"],
