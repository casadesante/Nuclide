/**
 * Organ-level wireframe schematics for the indications: the organ, its subsites and the regional lymph node
...
export const ORGAN_SCHEMATICS: OrganSchematic[] = [
  { id: "breast", name: "Breast", indications: ["tnbc", "breast-cancer", "breast-hr-positive", "breast-her2-positive", "male-breast-cancer", "ductal-carcinoma-in-situ", "hr-positive-early-high-risk", "hr-positive-metastatic-post-cdk46", "her2-low-metastatic-breast-cancer", "her2-positive-early-breast-cancer", "her2-positive-breast-brain-metastases", "tnbc-early", "tnbc-metastatic", "inflammatory-breast-cancer", "paget-disease-of-the-nipple", "phyllodes-tumour"],
    caption: "Most indications start in the ducts and drain first to the axillary nodes, which is why the armpit is checked and a sentinel node is sampled.",
    subsites: [
      { id: "ducts", label: "Ducts (most indications start here)", at: [0.35, 0.15, 0.85], match: ["ductal", "dcis", "no special type", "nst", "luminal", "basal", "her2", "claudin"] },
  ...
  { id: "colorectum", name: "Colon, rectum, anus and appendix", indications: ["peritoneal-mesothelioma", "colorectal", "rectal-cancer", "msi-high-colorectal", "braf-v600e-colorectal", "her2-amplified-colorectal", "kras-g12c-colorectal", "early-onset-colorectal", "anal", "appendiceal", "small-bowel", "small-intestinal-net", "anal-hsil-precursor", "localised-anal-cancer", "metastatic-anal-cancer", "low-grade-appendiceal-mucinous-neoplasm", "appendiceal-adenocarcinoma", "goblet-cell-adenocarcinoma", "localised-small-bowel-adenocarcinoma", "advanced-small-bowel-adenocarcinoma"],
  ...
  { id: "stomach-oesophagus", name: "Oesophagus and stomach", indications: ["gastric", "gastric-her2-positive", "gastric-cldn18-2-positive", "gastric-pdl1-high", "gastric-msi-high", "early-gastric-cancer", "oesophageal-squamous-cell-carcinoma", "oesophageal-adenocarcinoma", "esophageal", "gist", "gist-kit-exon-11", "gist-pdgfra-d842v", "gist-imatinib-resistant"],
    caption: "Squamous indications sit in the upper and middle oesophagus, adenocarcinomas at the junction and in the stomach; the stomach wall also gives rise to GIST from its pacemaker cells.",
    subsites: [
  ...
  { id: "pancreas-biliary", name: "Pancreas and bile ducts", indications: ["pancreatic", "cholangiocarcinoma", "intrahepatic-cholangiocarcinoma", "extrahepatic-cholangiocarcinoma", "biliary-tract-cancer", "neuroendocrine", "pancreatic-net", "grade-3-net", "extrapulmonary-nec", "gallbladder", "ampullary", "resectable-pdac", "borderline-resectable-pdac", "locally-advanced-pdac", "metastatic-pdac", "kras-g12c-pdac", "kras-wild-type-pdac", "brca-palb2-pdac", "msi-high-pdac", "pancreatic-acinar-cell-carcinoma", "ipmn-cystic-precursors", "pancreatoblastoma"],
    caption: "Most pancreatic indications arise in the head next to the bile duct, which is why jaundice is the presenting sign; bile duct indications are named by where along the tree they sit.",
    subsites: [
  ...
  { id: "liver", name: "Liver", indications: ["hcc", "hcc-early", "hcc-intermediate", "hcc-advanced", "hepatoblastoma"],
  ...
  { id: "prostate", name: "Prostate", indications: ["prostate", "prostate-low-risk", "prostate-intermediate-risk", "prostate-high-risk", "prostate-bcr", "prostate-mhspc", "prostate-nmcrpc", "prostate-mcrpc", "prostate-nepc"],
    caption: "About three quarters of indications arise in the peripheral zone at the back of the gland, the part a finger or a biopsy needle reaches; drainage is to the obturator and iliac nodes.",
    subsites: [
      { id: "peripheral", label: "Peripheral zone (most indications)", at: [0, -0.5, -0.75], match: ["acinar", "adenocarcinoma", "gleason-grade-group", "grade group", "localised", "castration", "hormone-sensitive", "mcrpc", "mhspc"] },
  ...
  { id: "female-pelvis", name: "Uterus, cervix, ovaries, tubes and vulva", indications: ["high-grade-serous-ovarian-cancer", "low-grade-serous-ovarian-cancer", "clear-cell-ovarian-cancer", "mucinous-ovarian-cancer", "granulosa-cell-tumour", "ovarian", "endometrial", "cervical", "vulvar", "gestational-trophoblastic", "uterine-sarcoma", "vaginal", "endometrial-pole-ultramutated", "endometrial-mmr-deficient", "endometrial-p53-abnormal", "endometrial-nsmp", "advanced-recurrent-endometrial-cancer", "uterine-carcinosarcoma", "early-cervical-cancer", "locally-advanced-cervical-cancer", "recurrent-metastatic-cervical-cancer", "platinum-sensitive-ovarian-cancer", "platinum-resistant-ovarian-cancer", "hpv-associated-vulvar-cancer", "hpv-independent-vulvar-cancer", "vaginal-squamous-cell-carcinoma", "vaginal-adenocarcinoma", "low-risk-gtn", "high-risk-gtn", "placental-site-trophoblastic-tumour"],
    caption: "Most high-grade ovarian indications begin at the tip of the fallopian tube; endometrial cancer lines the uterus, cervical cancer starts at the transformation zone; each drains to a different node group.",
    subsites: [
  ...
  { id: "testis", name: "Testis and retroperitoneum", indications: ["testicular", "seminoma", "non-seminoma", "paediatric-germ-cell-tumours"],
  ...
  { id: "eye", name: "Eye", indications: ["uveal-melanoma", "retinoblastoma"],
  ...
  { id: "brain", name: "Brain", indications: ["glioblastoma", "primary-cns-lymphoma", "medulloblastoma", "paediatric-low-grade-glioma", "dipg-dmg", "atrt", "ependymoma", "craniopharyngioma", "pituitary-tumours", "brain-tumours", "idh-mutant-astrocytoma", "oligodendroglioma", "paediatric-high-grade-glioma", "meningioma", "secondary-brain-tumours", "vestibular-schwannoma", "cns-germ-cell-tumours", "spinal-cord-tumours", "medulloblastoma-wnt", "medulloblastoma-shh", "medulloblastoma-group-3-4"],
  ...
  { id: "haematopoietic", name: "Bone marrow, lymph nodes and spleen", indications: ["marginal-zone-lymphoma", "cutaneous-t-cell-lymphoma", "primary-mediastinal-b-cell-lymphoma", "leukaemia", "aml", "all-leukemia", "cll", "cml", "dlbcl", "follicular-lymphoma", "hodgkin-lymphoma", "mantle-cell-lymphoma", "multiple-myeloma", "non-hodgkin-lymphoma", "mds", "myeloproliferative-neoplasms", "polycythaemia-vera", "essential-thrombocythaemia", "waldenstrom", "hairy-cell-leukemia", "peripheral-t-cell-lymphoma", "bpdcn", "burkitt-lymphoma", "hiv-associated-lymphoma", "cmml", "systemic-mastocytosis", "histiocytoses", "langerhans-cell-histiocytosis", "post-transplant-lymphoproliferative-disorder", "aml-flt3", "aml-idh", "aml-npm1-kmt2a", "aml-secondary", "apl", "aml-older-unfit", "smouldering-myeloma", "myeloma-transplant-eligible", "myeloma-transplant-ineligible", "myeloma-relapsed-refractory", "plasma-cell-leukaemia", "mds-lower-risk", "mds-higher-risk", "cll-treatment-naive", "cll-relapsed", "richter-transformation-cll", "cml-chronic-phase", "cml-advanced-phase", "primary-myelofibrosis", "all-paediatric-standard-risk", "all-paediatric-high-risk", "all-paediatric-ph-positive", "all-ph-like", "all-infant", "all-paediatric-relapsed", "aml-paediatric", "erdheim-chester-disease", "rosai-dorfman-disease", "lch-single-system", "lch-multisystem", "indolent-systemic-mastocytosis", "advanced-systemic-mastocytosis", "early-stage-classical-hodgkin-lymphoma", "advanced-stage-classical-hodgkin-lymphoma", "nodular-lymphocyte-predominant-hodgkin-lymphoma", "relapsed-refractory-hodgkin-lymphoma"],
  ...
  { id: "musculoskeletal", name: "Bone and soft tissue (limb cross-section)", indications: ["leiomyosarcoma", "liposarcoma", "synovial-sarcoma", "sarcoma", "osteosarcoma", "ewing-sarcoma", "rhabdomyosarcoma", "chordoma", "desmoid-tumour", "tenosynovial-giant-cell-tumour", "epithelioid-sarcoma", "vascular-tumours", "chondrosarcoma", "angiosarcoma", "undifferentiated-pleomorphic-sarcoma", "myxofibrosarcoma", "alveolar-soft-part-sarcoma", "pecoma", "epithelioid-haemangioendothelioma", "malignant-peripheral-nerve-sheath-tumour", "retroperitoneal-sarcoma", "extremity-soft-tissue-sarcoma"],
...
export function organFor(indicationId: string): OrganSchematic | undefined { return ORGAN_SCHEMATICS.find((o) => o.indications.includes(indicationId)); }
