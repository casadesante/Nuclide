/**
 * Biomarkers and alterations a tumour board would list, mapped to the Nuclide objects they unlock.
...
export type Biomarker = {
  ...
  note: string;
  /** Indication ids where this biomarker is most often tested; informational. */
  typical?: string[];
};
...
export const biomarkers: Biomarker[] = [
  ...
  { id: "nrg1", label: "NRG1 fusion", group: "genomic", matches: { targets: ["her3", "her2"], terms: ["gene-fusion"] }, note: "Zenocutuzumab in lung, pancreatic, and biliary indications.", typical: ["nsclc", "pancreatic", "cholangiocarcinoma"] },
  { id: "mtap-del", label: "MTAP deletion (CDKN2A co-deletion)", group: "genomic", matches: { technologies: ["synthetic-lethality-approaches"], terms: ["synthetic-lethality"] }, note: "PRMT5 inhibitors in phase 2/3; present in ~15% of indications including mesothelioma and glioblastoma.", typical: ["mesothelioma", "glioblastoma", "nsclc", "pancreatic"] },
  ...
  { id: "ctdna-mrd-pos", label: "ctDNA MRD positive after curative treatment", group: "genomic", matches: { technologies: ["mrd-testing", "liquid-biopsy"], terms: ["mrd", "ctdna"] }, note: "Predicts relapse; atezolizumab approved for ctDNA+ bladder cancer (IMvigor011); trials in other indications.", typical: ["urothelial", "colorectal", "tnbc", "nsclc"] },
  // ---- Germline ----
