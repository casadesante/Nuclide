...
export const deals: Deal[] = [
  ...
  { id: "d-2025-bms-biontech-bnt327", date: "2025-06-02", type: "co-development", from: c("biontech", "BioNTech"), to: c("bms", "Bristol Myers Squibb"),
    ...
    source: "https://news.bms.com/", status: "closed" },
  { id: "d-2023-gsk-hansoh-b7h3", date: "2023-12", type: "licence", from: c("hansoh-pharma", "Hansoh Pharma"), to: c("gsk", "GSK"),
  ...
  // ---------------- China-out licences 2021 to 2025 (PD-1s, kinase inhibitors, ADCs, bispecifics, CAR-T) ----------------
  { id: "d-2021-coherus-junshi-toripalimab", date: "2021-02-01", type: "licence", from: c("junshi", "Shanghai Junshi Biosciences"), to: x("Coherus BioSciences", "US"),
    assets: ["toripalimab"], assetText: "Toripalimab (Loqtorzi), anti-PD-1 antibody; options on two further programmes", upfront: "$150m", total: "up to $1.11bn",
    territories: "United States and Canada", refs: ["pd1"],
    note: "Led to the first FDA approval of a Chinese PD-1 antibody (nasopharyngeal carcinoma, October 2023).",
    source: "https://investors.coherus.com/news-releases", status: "closed" },
  { id: "d-2021-novartis-beigene-tislelizumab", date: "2021-01-11", type: "licence", from: c("beone", "BeiGene"), to: c("novartis", "Novartis"),
    assets: ["tislelizumab"], assetText: "Tislelizumab, anti-PD-1 antibody", upfront: "$650m", total: "up to $2.2bn",
    territories: "North America, Europe and Japan", refs: ["pd1"],
    note: "Terminated by mutual agreement in September 2023 after FDA review delays; BeiGene regained global rights and won FDA approval itself in 2024.",
    source: "https://www.novartis.com/news/media-releases", status: "terminated" },
  { id: "d-2021-seagen-remegen-disitamab", date: "2021-08-09", type: "licence", from: c("remegen", "RemeGen"), to: c("pfizer", "Seagen (now Pfizer)"),
    assets: ["disitamab-vedotin"], assetText: "Disitamab vedotin (RC48), HER2 ADC", upfront: "$200m", total: "up to $2.4bn",
    territories: "Worldwide except Asia (excluding Japan and Singapore)", refs: ["her2", "adc"],
    note: "The first major licence of a Chinese ADC to a Western company.",
    source: "https://www.remegen.com/", status: "closed" },
  { id: "d-2023-takeda-hutchmed-fruquintinib", date: "2023-01-23", type: "licence", from: c("hutchmed", "Hutchmed"), to: c("takeda", "Takeda"),
    assets: ["fruquintinib"], assetText: "Fruquintinib (Fruzaqla), VEGFR1-3 inhibitor", upfront: "$400m", total: "up to $1.13bn",
    territories: "Worldwide except mainland China, Hong Kong and Macau", refs: ["vegf"],
    note: "FDA approval followed in November 2023 on the global FRESCO-2 trial, the first for a Chinese-discovered drug in a common solid tumour.",
    source: "https://www.takeda.com/newsroom/newsreleases/2023/takeda-and-hutchmed-enter-into-an-exclusive-licensing-agreement/", status: "closed" },
  { id: "d-2023-merckkgaa-hengrui-parp1-cldn18", date: "2023-10-30", type: "licence", from: c("hengrui", "Jiangsu Hengrui Pharmaceuticals"), to: x("Merck KGaA", "DE"),
    assets: [], assetText: "HRS-1167, PARP1-selective inhibitor, and SHR-A1904, Claudin 18.2 ADC", upfront: "EUR 160m", total: "up to about EUR 1.4bn",
    territories: "Worldwide except mainland China, Hong Kong, Macau and Taiwan (option on Claudin 18.2 ADC co-development)", refs: ["parp", "cldn18-2", "adc"],
    source: "https://www.emdgroup.com/en/news/hengrui-licensing-agreement.html", status: "closed" },
  { id: "d-2023-gsk-hansoh-b7h4", date: "2023-10-20", type: "licence", from: c("hansoh-pharma", "Hansoh Pharma"), to: c("gsk", "GSK"),
    assets: [], assetText: "HS-20089 (GSK5733584), B7-H4 ADC", upfront: "$85m", total: "up to $1.485bn",
    territories: "Worldwide except mainland China, Hong Kong, Macau and Taiwan", refs: ["adc"],
    note: "First of two Hansoh ADC licences to GSK in late 2023 (see the B7-H3 deal).",
    source: "https://www.gsk.com/en-gb/media/press-releases/", status: "closed" },
  { id: "d-2023-novartis-legend-dll3-cart", date: "2023-11-13", type: "licence", from: c("legend-biotech", "Legend Biotech"), to: c("novartis", "Novartis"),
    assets: [], assetText: "LB2102, DLL3-directed CAR-T for small cell lung cancer, and other DLL3 CAR-T candidates", upfront: "$100m", total: "up to $1.01bn",
    territories: "Worldwide", refs: ["dll3", "car-t"],
    source: "https://www.legendbiotech.com/", status: "closed" },
  { id: "d-2024-biontech-biotheus", date: "2024-11-13", type: "acquisition", from: x("Biotheus", "CN"), to: c("biontech", "BioNTech"),
    assets: [], assetText: "Biotheus, developer of the PD-L1 x VEGF bispecific PM8002 (BNT327, pumitamig)", upfront: "$800m", total: "up to $950m",
    territories: "Company acquisition (BioNTech had licensed ex-China rights to PM8002 in November 2023)", refs: ["pdl1", "vegf"],
    note: "Pumitamig then became the subject of BioNTech's $11.1bn co-development with BMS in 2025.",
    source: "https://investors.biontech.de/", status: "closed" },
  { id: "d-2024-ideaya-hengrui-dll3-adc", date: "2024-12-30", type: "licence", from: c("hengrui", "Jiangsu Hengrui Pharmaceuticals"), to: x("IDEAYA Biosciences", "US"),
    assets: [], assetText: "SHR-4849 (IDE849), DLL3 ADC", upfront: "$75m", total: "up to about $1.045bn",
    territories: "Worldwide except Greater China", refs: ["dll3", "adc"],
    source: "https://ir.ideayabio.com/", status: "closed" },
  { id: "d-2025-roche-innovent-dll3-adc", date: "2025-01-02", type: "licence", from: c("innovent", "Innovent Biologics"), to: c("roche-genentech", "Roche"),
    assets: [], assetText: "IBI3009, DLL3 ADC for small cell lung cancer", upfront: "$80m", total: "up to $1.0bn",
    territories: "Worldwide", refs: ["dll3", "adc"],
    source: "https://www.innoventbio.com/", status: "closed" },
  { id: "d-2025-gsk-hengrui-twelve-programmes", date: "2025-07-28", type: "licence", from: c("hengrui", "Jiangsu Hengrui Pharmaceuticals"), to: c("gsk", "GSK"),
    assets: [], assetText: "HRS-9821 (PDE3/4 inhibitor for COPD) plus options on up to eleven further programmes across respiratory, immunology, inflammation and oncology", upfront: "$500m", total: "up to about $12bn",
    territories: "Worldwide except mainland China, Hong Kong, Macau and Taiwan",
    note: "Largest China-out agreement by headline value; mostly outside oncology but the clearest signal of Western pharma sourcing pipelines from China.",
    source: "https://www.gsk.com/en-gb/media/press-releases/", status: "closed" },
  { id: "d-2025-takeda-innovent-ibi363-ibi343", date: "2025-10-22", type: "co-development", from: c("innovent", "Innovent Biologics"), to: c("takeda", "Takeda"),
    assets: [], assetText: "IBI363, PD-1 x IL-2 alpha-bias bispecific antibody-cytokine fusion, and IBI343, Claudin 18.2 ADC; option on IBI3001 (EGFR x B7-H3 ADC)", upfront: "$1.2bn (including a $100m equity investment premium)", total: "up to $11.4bn",
    territories: "Worldwide except Greater China for IBI343; co-development and co-commercialisation of IBI363 in the United States, Takeda leads elsewhere outside Greater China", refs: ["pd1", "cldn18-2", "adc"],
    note: "Largest upfront paid for a Chinese oncology asset to date.",
    source: "https://www.innoventbio.com/", status: "closed" },
  { id: "d-2025-sinobiopharm-lanova", date: "2025-07", type: "acquisition", from: x("LaNova Medicines", "CN"), to: c("sino-biopharm", "Sino Biopharmaceutical"),
