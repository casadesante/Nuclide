/**
 * Anatomical regions for the body map: which indications arise there and which
...
export const BODY_REGIONS: BodyRegion[] = [
  { id: "brain", label: "Brain", hit: "fill", anchor: [158, 70], side: "L", labelY: 60,
    ...
    indications: ["glioblastoma"], technologies: ["mri", "pet-mri", "sbrt", "proton-therapy", "ttfields", "fluorescence-guided-surgery", "methylation-profiling"] },
  { id: "head-neck", label: "Head & neck", hit: "fill", anchor: [232, 128], side: "R", labelY: 110,
    ...
    indications: ["head-and-neck"], technologies: ["photoimmunotherapy", "bnct", "proton-therapy", "imrt-igrt", "robotic-surgery", "hpv-vaccine"] },
  { id: "thyroid", label: "Thyroid", hit: "fill", anchor: [222, 180], side: "R", labelY: 160,
    ...
    indications: ["thyroid"], technologies: ["ultrasound", "radioligand-therapy"] },
  { id: "oesophagus", label: "Oesophagus", hit: "stroke", anchor: [204, 230], side: "R", labelY: 210,
    ...
    indications: ["esophageal"], technologies: ["pet-ct", "imrt-igrt", "robotic-surgery", "hyperthermia"] },
  { id: "lung", label: "Lungs", hit: "fill", anchor: [136, 280], side: "L", labelY: 262,
    paths: [LEFT_LUNG, mirror(LEFT_LUNG)],
    indications: ["nsclc", "sclc", "mesothelioma"], technologies: ["ct", "pet-ct", "sbrt", "proton-therapy", "thermal-ablation", "robotic-surgery", "liquid-biopsy", "ttfields"] },
  { id: "breast", label: "Breast", hit: "fill", anchor: [262, 300], side: "R", labelY: 300,
    paths: [LEFT_BREAST, mirror(LEFT_BREAST)],
    indications: ["tnbc", "breast-hr-positive", "breast-her2-positive"], technologies: ["mammography", "ultrasound", "mri", "sentinel-node", "brachytherapy", "imrt-igrt", "fluorescence-guided-surgery", "digital-pathology-ai"] },
  { id: "liver", label: "Liver", hit: "fill", anchor: [126, 350], side: "L", labelY: 340,
    ...
    indications: ["hcc", "cholangiocarcinoma"], technologies: ["ultrasound", "mri", "thermal-ablation", "hifu-histotripsy", "sbrt", "radioligand-therapy", "fapi-pet"] },
  { id: "stomach", label: "Stomach", hit: "fill", anchor: [262, 348], side: "R", labelY: 350,
    ...
    indications: ["gastric"], technologies: ["fapi-pet", "hipec", "robotic-surgery", "car-t"] },
  { id: "pancreas", label: "Pancreas", hit: "fill", anchor: [252, 392], side: "R", labelY: 400,
    ...
    indications: ["pancreatic"], technologies: ["fapi-pet", "mr-linac", "irreversible-electroporation", "ttfields", "carbon-ion", "hifu-histotripsy", "mced"] },
  { id: "kidney", label: "Kidneys", hit: "fill", anchor: [126, 400], side: "L", labelY: 392,
    paths: [LEFT_KIDNEY, mirror(LEFT_KIDNEY)],
    indications: ["rcc"], technologies: ["ct", "thermal-ablation", "hifu-histotripsy", "robotic-surgery", "sbrt"] },
  { id: "colon", label: "Colon & rectum", hit: "stroke", anchor: [134, 470], side: "L", labelY: 460,
    ...
    indications: ["colorectal"], technologies: ["mrd-testing", "mced", "hipec", "robotic-surgery", "thermal-ablation", "sbrt"] },
  { id: "bladder", label: "Bladder", hit: "fill", anchor: [222, 486], side: "R", labelY: 480,
    ...
    indications: ["urothelial"], technologies: ["mrd-testing", "robotic-surgery", "oncolytic-virus", "imrt-igrt"] },
  { id: "prostate", label: "Prostate", hit: "fill", anchor: [212, 508], side: "R", labelY: 520, sex: "male",
    ...
    indications: ["prostate"], technologies: ["psma-pet", "mri", "brachytherapy", "hifu-histotripsy", "irreversible-electroporation", "sbrt", "mr-linac", "radioligand-therapy", "targeted-alpha-therapy", "robotic-surgery"] },
  { id: "pelvis-female", label: "Ovary, uterus, cervix", hit: "fill", anchor: [232, 456], side: "R", labelY: 440, sex: "female",
    ...
    indications: ["ovarian", "endometrial", "cervical"], technologies: ["brachytherapy", "hipec", "hpv-vaccine", "robotic-surgery", "hyperthermia", "mced"] },
  { id: "lymph", label: "Lymph nodes", hit: "fill", anchor: [116, 268], side: "L", labelY: 232, systemWide: true,
    ...
    indications: ["dlbcl", "hodgkin-lymphoma"], technologies: ["fdg-pet", "car-t", "t-cell-engager", "imrt-igrt"] },
  { id: "blood", label: "Blood & marrow", hit: "fill", anchor: [150, 452], side: "L", labelY: 430, systemWide: true,
    ...
    indications: ["aml", "all-leukemia", "cll", "multiple-myeloma"], technologies: ["car-t", "t-cell-engager", "mrd-testing", "whole-body-mri", "epigenetic-drugs"] },
  { id: "bone", label: "Bone & soft tissue", hit: "stroke", anchor: [146, 620], side: "L", labelY: 600, systemWide: true,
    ...
    indications: ["sarcoma"], technologies: ["proton-therapy", "carbon-ion", "hyperthermia", "spect", "mri"] },
  { id: "skin", label: "Skin", hit: "stroke", anchor: [96, 560], side: "L", labelY: 540, systemWide: true,
    ...
    indications: ["melanoma"], technologies: ["sentinel-node", "oncolytic-virus", "til-therapy", "brachytherapy"] },
  { id: "neuroendocrine", label: "Neuroendocrine (gut, lung, pancreas)", hit: "fill", anchor: [262, 420], side: "R", labelY: 570, systemWide: true,
    ...
    indications: ["neuroendocrine", "neuroblastoma"], technologies: ["radioligand-therapy", "targeted-alpha-therapy", "pet"] },
];
