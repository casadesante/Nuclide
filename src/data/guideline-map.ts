 ...
 * Keyed `indicationId#setting`. Bodies: NCCN (US), ESMO (Europe, with ESMO-MCBS grade where published), NICE (England,
...
export const guidelineMap: GuidelineMapEntry[] = [
  { key: "tnbc#Stage II-III, neoadjuvant", indicationId: "tnbc", setting: "Stage II-III, neoadjuvant", intervention: "Pembrolizumab with chemotherapy before surgery, continued after (KEYNOTE-522)", refs: ["pembrolizumab", "keynote-522"], bodies: [
  ...
  { key: "breast-hr-positive#Metastatic, HER2-low, after chemotherapy", indicationId: "breast-hr-positive", setting: "Metastatic, HER2-low, after chemotherapy", intervention: "Trastuzumab deruxtecan for HER2-low metastatic breast cancer after one chemotherapy (DESTINY-Breast04)", refs: ["trastuzumab-deruxtecan", "destiny-breast04"], bodies: [
  ...
  { key: "breast-her2-positive#Metastatic, second line", indicationId: "breast-her2-positive", setting: "Metastatic, second line", intervention: "Trastuzumab deruxtecan after trastuzumab and a taxane (DESTINY-Breast03)", refs: ["trastuzumab-deruxtecan", "destiny-breast03"], bodies: [
  ...
  { key: "breast-her2-positive#Metastatic, later lines and brain metastases", indicationId: "breast-her2-positive", setting: "Metastatic, later lines and brain metastases", intervention: "Tucatinib with trastuzumab and capecitabine (HER2CLIMB)", refs: ["tucatinib", "her2climb"], bodies: [
  ...
  { key: "breast-hr-positive#Adjuvant, high risk", indicationId: "breast-hr-positive", setting: "Adjuvant, high risk", intervention: "Abemaciclib for 2 years with endocrine therapy (monarchE)", refs: ["abemaciclib", "monarche"], bodies: [
  ...
  { key: "tnbc#Adjuvant, germline BRCA, high risk", indicationId: "tnbc", setting: "Adjuvant, germline BRCA, high risk", intervention: "Olaparib for one year after chemotherapy (OlympiA)", refs: ["olaparib", "olympia"], bodies: [
  ...
  { key: "nsclc#Metastatic, EGFR-mutant, first line", indicationId: "nsclc", setting: "Metastatic, EGFR-mutant, first line", intervention: "Osimertinib first line (FLAURA)", refs: ["osimertinib", "flaura2"], bodies: [
  ...
  { key: "nsclc#Adjuvant, EGFR-mutant, stage IB-IIIA", indicationId: "nsclc", setting: "Adjuvant, EGFR-mutant, stage IB-IIIA", intervention: "Osimertinib for 3 years after resection (ADAURA)", refs: ["osimertinib", "adaura"], bodies: [
  ...
  { key: "nsclc#Stage III unresectable, after chemoradiation", indicationId: "nsclc", setting: "Stage III unresectable, after chemoradiation", intervention: "Durvalumab consolidation for 12 months (PACIFIC)", refs: ["durvalumab", "pacific"], bodies: [
  ...
  { key: "rcc#Untreated advanced clear-cell, intermediate or poor risk", indicationId: "rcc", setting: "Untreated advanced clear-cell, intermediate or poor risk", intervention: "Nivolumab plus ipilimumab (CheckMate 214)", refs: ["nivolumab", "ipilimumab", "checkmate-214"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended first line for intermediate and poor risk.", grade: "I, A; ESMO-MCBS 4", date: "2021", url: esmo("esmo-clinical-practice-guidelines-genitourinary-indications/renal-cell-carcinoma") },
  ...
  { key: "rcc#Untreated advanced clear-cell, any risk", indicationId: "rcc", setting: "Untreated advanced clear-cell, any risk", intervention: "Pembrolizumab plus axitinib (KEYNOTE-426)", refs: ["pembrolizumab", "axitinib", "keynote-426"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended first line across IMDC risk groups.", grade: "I, A; ESMO-MCBS 4", date: "2021", url: esmo("esmo-clinical-practice-guidelines-genitourinary-indications/renal-cell-carcinoma") },
  ...
  { key: "colorectal#Metastatic, MSI-high / dMMR, first line", indicationId: "colorectal", setting: "Metastatic, MSI-high / dMMR, first line", intervention: "Pembrolizumab monotherapy (KEYNOTE-177)", refs: ["pembrolizumab", "keynote-177"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended first line for MSI-high disease.", grade: "I, A; ESMO-MCBS 4", date: "2023-01", url: esmo("esmo-clinical-practice-guidelines-gastrointestinal-indications/metastatic-colorectal-cancer") },
  ...
  { key: "urothelial#Metastatic, first line", indicationId: "urothelial", setting: "Metastatic, first line", intervention: "Enfortumab vedotin plus pembrolizumab (EV-302)", refs: ["enfortumab-vedotin", "pembrolizumab", "ev-302"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended first line in the living guideline.", grade: "I, A; ESMO-MCBS 4", date: "2024", url: esmo("esmo-clinical-practice-guidelines-genitourinary-indications/bladder-cancer") },
  ...
  { key: "esophageal#Adjuvant after chemoradiation, residual disease", indicationId: "esophageal", setting: "Adjuvant after chemoradiation, residual disease", intervention: "Nivolumab for one year after neoadjuvant chemoradiation and surgery with residual disease (CheckMate 577)", refs: ["nivolumab", "checkmate-577"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended in the oesophageal cancer guideline for residual disease after neoadjuvant chemoradiation.", grade: "I, A", date: "2022", url: esmo("esmo-clinical-practice-guidelines-gastrointestinal-indications/oesophageal-cancer") },
  ...
  { key: "ovarian#Newly diagnosed, BRCA-mutated, maintenance", indicationId: "ovarian", setting: "Newly diagnosed, BRCA-mutated, maintenance", intervention: "Olaparib maintenance for 2 years after platinum response (SOLO-1)", refs: ["olaparib", "solo-1"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended maintenance for BRCA-mutated disease.", grade: "I, A", date: "2023-10", url: esmo("esmo-clinical-practice-guidelines-gynaecological-indications/newly-diagnosed-and-relapsed-epithelial-ovarian-carcinoma") },
    { body: "NICE", stance: "restricted", recommendation: "Recommended within the Indication Drugs Fund for BRCA-mutated advanced ovarian cancer after first-line platinum response; routine commissioning followed later.", grade: "TA598", date: "2019-07", url: ta(598) },
  ...
  { key: "melanoma#Unresectable or metastatic, BRAF V600-mutant, first line", indicationId: "melanoma", setting: "Unresectable or metastatic, BRAF V600-mutant, first line", intervention: "Immunotherapy before BRAF/MEK inhibition (DREAMseq)", refs: ["nivolumab", "ipilimumab", "dabrafenib-trametinib", "dreamseq"], bodies: [
  ...
  { key: "cll#Untreated, del(17p) or TP53-mutated", indicationId: "cll", setting: "Untreated, del(17p) or TP53-mutated", intervention: "Targeted therapy (BTK inhibitor or venetoclax-obinutuzumab) instead of chemoimmunotherapy", refs: ["acalabrutinib", "venetoclax", "obinutuzumab", "cll14", "elevate-tn"], bodies: [
  ...
  { key: "hcc#Unresectable, first line", indicationId: "hcc", setting: "Unresectable, first line", intervention: "Atezolizumab plus bevacizumab (IMbrave150)", refs: ["atezolizumab", "bevacizumab", "imbrave150"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended first line.", grade: "I, A; ESMO-MCBS 4", date: "2021", url: esmo("esmo-clinical-practice-guidelines-gastrointestinal-indications/hepatocellular-carcinoma") },
  ...
  { key: "gastric#Metastatic, HER2-negative, first line", indicationId: "gastric", setting: "Metastatic, HER2-negative, first line", intervention: "Nivolumab with fluoropyrimidine-platinum chemotherapy (CheckMate 649)", refs: ["nivolumab", "checkmate-649"], bodies: [
    ...
    { body: "ESMO", stance: "restricted", recommendation: "Recommended for CPS 5 or above only; benefit not shown below that threshold.", grade: "I, A; ESMO-MCBS 4 (CPS 5 or above)", date: "2022-10", url: esmo("esmo-clinical-practice-guidelines-gastrointestinal-indications/gastric-cancer") },
    { body: "NICE", stance: "restricted", recommendation: "Recommended only for PD-L1 CPS 5 or above.", grade: "TA857", date: "2023-02", url: ta(857) },
  ] },
  { key: "endometrial#Advanced or recurrent, dMMR, first line", indicationId: "endometrial", setting: "Advanced or recurrent, dMMR, first line", intervention: "Dostarlimab with carboplatin-paclitaxel (RUBY)", refs: ["dostarlimab", "ruby"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended for dMMR advanced or recurrent disease in the living guideline.", grade: "I, A", date: "2024", url: esmo("esmo-clinical-practice-guidelines-gynaecological-indications/endometrial-cancer") },
  ...
  { key: "prostate#Metastatic castration-resistant, PSMA PET-positive", indicationId: "prostate", setting: "Metastatic castration-resistant, PSMA PET-positive", intervention: "177Lu-PSMA-617 (VISION, PSMAfore)", refs: ["pluvicto", "vision", "psmafore"], bodies: [
    ...
    { body: "ESMO", stance: "recommended", recommendation: "Recommended after AR pathway inhibitor and taxane in the living guideline.", grade: "I, A; ESMO-MCBS 4", date: "2024", url: esmo("esmo-clinical-practice-guidelines-genitourinary-indications/prostate-cancer") },
