...
const RECORDS: UsCoverage[] = [
  ...
  rec("tislelizumab", "B", `${IV} FDA-approved (oesophageal and gastric indications); newer entrant with lower US uptake.`, "covered with prior authorisation", PA_IV, { pap: [...PAP.beigene, ...PAP.charities], oop: B_OOP }),
  ...
  rec("axicabtagene-ciloleucel", "B", `${CART} HCPCS Q2041.`, "covered with prior authorisation", CART_COM, {
    ...
    price: { value: 373000, per: "one-time treatment, launch list price", source: "National Cancer Institute, Indication Currents, October 2017 (reporting Kite/Gilead's announced price)", url: "https://www.indication.gov/news-events/cancer-currents-blog/2017/yescarta-fda-lymphoma", year: 2017 },
  ...
  rec("tisagenlecleucel", "B", `${CART} HCPCS Q2042.`, "covered with prior authorisation", CART_COM, {
    ncd: "110.24", url: SRC.carT.url, sources: [SRC.carT, SRC.inpatient],
    price: { value: 475000, per: "one-time treatment for paediatric/young adult B-ALL, launch list price", source: "National Cancer Institute, Indication Currents, September 2017 (reporting Novartis's announced price)", url: "https://www.indication.gov/news-events/cancer-currents-blog/2017/tisagenlecleucel-fda-childhood-leukemia", year: 2017 },
...
export const US_SYSTEM: Array<{ id: string; title: string; plain: string; detail: string; links: Array<{ label: string; url: string }> }> = [
  ...
  },
  {
    ...
    links: [
      { label: "NCI PDQ: Financial toxicity of cancer treatment", url: "https://www.indication.gov/about-cancer/managing-care/track-care-costs/financial-toxicity-pdq" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "NCI: Paying for clinical trials", url: "https://www.indication.gov/research/participate/clinical-trials/paying" },
    ],
  },
  {
    id: "assistance",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "American Cancer Society: Financial and insurance matters", url: "https://www.indication.org/cancer/financial-insurance-matters.html" },
    ],
  },
];
