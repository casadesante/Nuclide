...
export type Journey = { id: string; indication: string; stage: string; title: string; tldr: string; phases: JourneyPhase[]; decisions: Decision[]; sources: string[]; asOf: string };
...
export const JOURNEYS: Journey[] = [
  { id: "tnbc-stage-2-3", indication: "tnbc", stage: "Stage II-III (operable)", title: "Triple-negative breast cancer, stage II-III", asOf,
  ...
  { id: "breast-hr-positive-early", indication: "breast-hr-positive", stage: "Stage I-II (early)", title: "HR-positive, HER2-negative breast cancer, stage I-II", asOf,
  ...
  { id: "breast-her2-positive-early", indication: "breast-her2-positive", stage: "Stage II-III (operable)", title: "HER2-positive breast cancer, stage II-III", asOf,
  ...
  { id: "nsclc-resectable", indication: "nsclc", stage: "Stage II-IIIA (resectable)", title: "Non-small-cell lung cancer, resectable stage II-IIIA", asOf,
  ...
  { id: "colorectal-stage-3", indication: "colorectal", stage: "Stage III colon", title: "Colon cancer, stage III", asOf,
  ...
  { id: "prostate-high-risk-localised", indication: "prostate", stage: "High-risk localised", title: "Prostate cancer, high-risk localised", asOf,
  ...
  { id: "dlbcl-advanced", indication: "dlbcl", stage: "Advanced stage (III-IV), first line", title: "Diffuse large B-cell lymphoma, advanced stage", asOf,
  ...
  { id: "glioblastoma-newly-diagnosed", indication: "glioblastoma", stage: "Newly diagnosed", title: "Glioblastoma, newly diagnosed", asOf,
  ...
  { id: "pancreatic-resectable", indication: "pancreatic", stage: "Resectable", title: "Pancreatic cancer, resectable", asOf,
  ...
  { id: "melanoma-stage-3", indication: "melanoma", stage: "Stage III (node-positive)", title: "Melanoma, stage III", asOf,
  ...
  { id: "multiple-myeloma-transplant-eligible", indication: "multiple-myeloma", stage: "Newly diagnosed, transplant-eligible", title: "Multiple myeloma, newly diagnosed and fit for transplant", asOf,
...
export function journeysForCancer(indicationId: string): Journey[] { return JOURNEYS.filter((j) => j.indication === indicationId); }
