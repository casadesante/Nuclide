...
const TABLES: Record<Exclude<Lang, "en">, Record<string, string>> = { es: {}, zh: {}, pt: {}, hi: {}, fr: {}, de: {}, ja: {}, ar: {} };
/** A named review of a translated TL;DR. None yet in this corpus. */
export type TranslationReview = { lang: Exclude<Lang, "en">; reviewer: string; role?: string; date: string };
const reviewed: Record<string, TranslationReview[]> = {};
