...
describe("csv", () => {
  ...
  it("filenames are slugged and dated", () => {
    expect(exportFilename("Treatments & tests", "csv", new Date("2026-09-09T10:00:00Z"))).toBe("nuclide-treatments-tests-2026-09-09.csv");
    expect(exportFilename("***", "json", new Date("2026-01-02T00:00:00Z"))).toBe("nuclide-table-2026-01-02.json");
  });
