 ...
 * /api/v1/my-indications.json (written by scripts/build-api.ts), fetched the first time a component needs it: a
...
export const MY_CANCERS_URL = "/api/v1/my-indications.json";
const KEY = "nuclide:my-indications:v1";
