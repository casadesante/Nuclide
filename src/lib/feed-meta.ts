...
export const FEEDS: FeedDef[] = [
  ...
  { id: "fda", label: "FDA approvals", path: "fda/recent.json", script: "scripts/fetch-fda.ts", workflow: "refresh-fda.yml", cadenceDays: 7, source: "FDA OCE approval notifications and openFDA drugsfda",
