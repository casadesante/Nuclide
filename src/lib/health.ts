...
const KIND_PRIORITY: Kind[] = ["indication", "drug", "target", "trial", "technology", "pathway", "company", "institution", "person", "paper", "journal", "collection", "bottleneck", "roadmap", "pairing", "term", "idea", "section"];
