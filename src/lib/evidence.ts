...
export function evidenceFor(e: Entity): Evidence | null {
  if (e.kind === "indication" || e.kind === "section" || e.kind === "institution" || e.kind === "company" || e.kind === "collection" || e.kind === "term" || e.kind === "roadmap" || e.kind === "idea" || e.kind === "pairing" || e.kind === "pathway") return null;
