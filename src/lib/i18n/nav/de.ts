...
export const navDe: NavDict = {
  ...
  "/universe/": ["Das Universum", "Jedes zugelassene Produkt, jede Studie, Publikation, Kongress-Abstract, jedes Patent und jeder veröffentlichte ungedeckte Bedarf bei Radiopharmaka, verknüpft und durchsuchbar."],
  "/universe/ideas/": ["Ideen aus den Daten", "Aus den Verknüpfungen berechnete Chancen, jeweils mit der zugrunde liegenden Evidenz."],
  "/universe/gaps/": ["Ungedeckter Bedarf", "Zitierte Aussagen zu ungedecktem Bedarf aus Publikationen und Kongress-Abstracts, filterbar nach Indikation, Zielstruktur und Thema."],
