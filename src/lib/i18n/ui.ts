...
export const EN = {
  ...
  // ---- header ----
  "header.home": "Nuclide home",
  "header.search": "Search",
  "header.openSearch": "Open search (Command K)",
  "header.askNuclide": "Ask Nuclide",
  "header.forMe": "For me",
  "header.cancerTypes": "Indication types",
  ...
  "header.github": "Nuclide on GitHub",
  ...
  "offer.switch": "Nuclide is also available in {language}.",
  "offer.switchButton": "Switch to {language}",

  // ---- analytics consent (bar at the foot of the viewport, footer control, /privacy/ panel) ----
  "consent.text": "Nuclide uses Google Analytics to count visits. No advertising, nothing sold.",
  "consent.allow": "Allow",
  ...
  "footer.medical": "Nuclide is an information resource, not medical advice. Nothing here replaces a conversation with a qualified clinician. Never delay care because of something you read here; in an emergency, call your local emergency services.",
  "footer.terms": "Terms of use",
  "footer.privacy": "Privacy policy",
  "footer.commercial": "Commercial licences",
  "footer.madeBy": "Made with heart and soul by",
  "footer.licence": "© 2026 Nuclide. Code MIT. The data are free for individual and educational use with the attribution “Data from Nuclide (nuclide.cc)”, under CC BY-NC 4.0. Commercial use must contact us to pay for the data.",
  ...
  "watch.feedTitle": "Atom feed of every change on Nuclide, for a feed reader",
  "watch.saved": "Saved",
