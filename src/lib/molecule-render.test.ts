...
describe("backbone geometry", () => {
  ...
  it("agrees with the PDB HELIX/SHEET records well above chance on a peptidase (5O5T)", () => {
    const m = JSON.parse(readFileSync("public/structures/pdb-5O5T.json", "utf8")) as Mol;
    let agree = 0, total = 0;
