...
export const SITE_NAME = "Nuclide";
 ...
 * template appends " · Nuclide" to `<title>` and we mirror that for the social cards.
 */
export const FEED_TYPES = { "application/atom+xml": [ { url: "/feeds/changelog.xml", title: "Nuclide changelog" }, { url: "/feeds/regulatory.xml", title: "Nuclide regulatory events" }, { url: "/feeds/calendar.xml", title: "Nuclide readout calendar" }, { url: "/feeds/pulse.xml", title: "Nuclide research pulse" } ] };
...
/**
 * "Name · Kind" (layout template adds " · Nuclide"). Long names, mostly registry trial titles and paper titles, are cut
 ...
 * packages/nuclide-mcp/src/server.ts and src/lib/webmcp-tools.ts; src/lib/agent-surface.test.ts keeps them in step.
 */
