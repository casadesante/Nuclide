/**
 * Ask Nuclide, step one: what is being asked, and about which records.
 *
...
export function kindPriority(intent: Intent, kind: Kind): number {
  const table: Partial<Record<Intent, Partial<Record<Kind, number>>>> = {
    ...
    "regional-approvals": { technology: 0.5, indication: 0.5, target: 0.45, drug: 0.35, term: 0.3, section: 0.2 },
    mechanism: { drug: 0.5, technology: 0.45, pathway: 0.4, target: 0.4, term: 0.25, indication: 0.1 },
    "side-effects": { drug: 0.5, technology: 0.4, term: 0.2, indication: 0.1 },
    trials: { trial: 0.5, drug: 0.45, indication: 0.4, target: 0.35, technology: 0.35, term: 0.1 },
    results: { trial: 0.5, drug: 0.4, paper: 0.35, technology: 0.3, indication: 0.2, term: 0.1 },
    evidence: { technology: 0.5, drug: 0.3, term: 0.3, trial: 0.25, paper: 0.25, indication: 0.2, target: 0.15 },
    compare: { technology: 0.3, drug: 0.3, indication: 0.3, target: 0.3, trial: 0.3, term: 0.3, pathway: 0.3 },
    prognosis: { indication: 0.5, term: 0.1, drug: 0.1, trial: 0.1 },
    who: { company: 0.5, institution: 0.5, person: 0.5, collection: 0.45, drug: 0.4, journal: 0.35, technology: 0.3, trial: 0.3, indication: 0.2, term: 0.1 },
    investors: { company: 0.5, technology: 0.4, target: 0.35, indication: 0.3, section: 0.2, term: 0.15, drug: 0.15 },
    companies: { technology: 0.5, target: 0.5, indication: 0.45, company: 0.45, pathway: 0.3, term: 0.3, section: 0.3, drug: 0.3, institution: 0.1 },
