...
const NOISE = new Set<string>([
  ...
  "index", "html", "htm", "php", "aspx", "www", "amp", "page", "pages", "api", "v1", "en", "zh", "json", "xml", "nuclide", "cc",
]);
...
export const MISSED_PATHS_KEY = "nuclide:missed-paths";
...
export function brokenLinkIssueUrl(path: string, referrer?: string): string {
  const url = `https://nuclide.cc${path}`;
