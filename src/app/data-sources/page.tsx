...
export const metadata: Metadata = {
  title: "Open data",
  description: "Every open database Nuclide pulls from, with what we take, how often, and under which licence; and the databases we could extend to, grouped by what they would fuel.",
};
...
/** One row per source. The name links to the Nuclide collection page when the source is also a collection object, otherwise to the source itself. */
...
const IN_USE_COLS: ColDef[] = [
  { key: "fuels", label: "Fuels", tip: "The Nuclide kinds, pages or checks this source feeds." },
...
const CANDIDATE_COLS: ColDef[] = [
  ...
  { key: "fuels", label: "Would fuel", hide: "hidden md:table-cell", tip: "The Nuclide kinds, pages or checks this source would feed." },
  { key: "access", label: "Access", hide: "hidden sm:table-cell" },
  { key: "licence", label: "Licence", hide: "hidden lg:table-cell" },
    ...
    <>
      ...
      <Container className="pb-16">
        <div className="grid gap-4 md:grid-cols-2 mb-8 max-w-5xl">
          ...
          <div className="card p-4 text-sm">
            ...
            <ul className="list-disc pl-5 space-y-1 text-muted">
              ...
              <li>The corpus is CC BY-NC 4.0 (free for non-commercial use, commercial use licensed by Nuclide): name Nuclide and link to the repository; upstream licences stay attached to what came from upstream.</li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm text-muted mb-3 max-w-3xl">What we already pull from, what we take, the script or component that reads it, and how often. Click a chip to filter; the name opens the Nuclide collection page when there is one.</p>
