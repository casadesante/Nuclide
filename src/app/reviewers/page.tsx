...
export const metadata: Metadata = pageMeta({ title: "Reviewer roster", description: "The clinicians, scientists and patient advocates who have signed off Nuclide pages: what they reviewed, on which track, and their declared conflicts of interest.", path: "/reviewers/" });
    ...
    <>
      ...
      <Container className="pb-16">
        ...
        <section className="mt-12 max-w-3xl">
          ...
          <p className="text-sm text-muted mt-3">Have a <Link className="underline" href="/people/">person record</Link> in Nuclide? Say so in the form and the badge links to it.</p>
        </section>
      </Container>
    </>
  );
