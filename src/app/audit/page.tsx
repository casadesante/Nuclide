...
export const metadata: Metadata = pageMeta({ title: "Audit", description: "Automated staleness, contradiction, sourcing, hygiene, link and registry fact-check findings for the Nuclide corpus.", path: "/audit/" });
      ...
      <Container className="pb-16">
            ...
            <div className="space-y-6">
              {checks.map(([check, list]) => (
                <details key={check} className="card" open={list.some((f) => f.severity === "high")}>
                  ...
                  <div className="overflow-x-auto"><table className="nuclide"><thead><tr><th>Entity</th><th>Kind</th><th>Detail</th></tr></thead>
        ...
        {fc ? (
          <>
            ...
            {fc.mismatches.length ? (
              <div className="card overflow-x-auto"><table className="nuclide"><thead><tr><th>Severity</th><th>Check</th><th>Entity</th><th>Recorded</th><th>Registry</th></tr></thead>
            ...
            {patches && patches.patches.length > 0 && (
              <>
                ...
                <div className="card overflow-x-auto"><table className="nuclide"><thead><tr><th>Entity</th><th>Field</th><th>Current</th><th>Proposed</th><th>Why</th></tr></thead>
        ...
        {links ? (
          <>
            ...
            {broken.length ? (
              <div className="card overflow-x-auto"><table className="nuclide"><thead><tr><th>Status</th><th>URL</th><th>Cited by</th><th>Archive</th></tr></thead>
            ...
            {moved.length > 0 && (
              <details className="card mt-4"><summary className="cursor-pointer px-4 py-3 text-sm font-medium">{moved.length} links redirect to a different domain</summary>
                <div className="overflow-x-auto"><table className="nuclide"><thead><tr><th>URL</th><th>Now at</th><th>Cited by</th></tr></thead>
        ...
        <div className="card overflow-x-auto"><table className="nuclide"><thead><tr><th>Entity</th><th>Kind</th><th>Last checked</th><th>Days</th></tr></thead>
