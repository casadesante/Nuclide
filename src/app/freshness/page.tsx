...
export const metadata: Metadata = pageMeta({ title: "Freshness", description: "How old is too old for each kind of Nuclide record, by review track, and which records are past their re-check date.", path: "/freshness/" });
    ...
    <>
      ...
      <Container className="pb-16">
        ...
        <div className="card overflow-x-auto mb-10">
          <table className="nuclide"><thead><tr><th>Track</th><th>Owns</th><th>Checked</th><th>Past due</th><th>Critical</th></tr></thead>
        ...
        <div className="card overflow-x-auto mb-10">
          <table className="nuclide"><thead><tr><th>Records</th><th>Track</th><th>Max age (days)</th><th>Critical</th><th>Checked</th><th>Past due</th></tr></thead>
        ...
        {f.stale.length === 0 && f.calendarStale.length === 0 ? <div className="card p-6 text-sm text-muted">Nothing is past due: every record and calendar event was checked within its SLA when this page was built ({f.today}).</div> : (
          <>
            {f.calendarStale.length > 0 && (
              <div className="card overflow-x-auto mb-6"><table className="nuclide"><thead><tr><th>Calendar event</th><th>Kind</th><th>Date</th><th>Days ago</th></tr></thead>
            ...
            {shown.length > 0 && (
              <div className="card overflow-x-auto"><table className="nuclide"><thead><tr><th>Entity</th><th>Kind</th><th>SLA</th><th>Last checked</th><th>Days over</th></tr></thead>
