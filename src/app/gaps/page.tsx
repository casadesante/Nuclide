...
export const metadata: Metadata = pageMeta({ title: "Gaps to fill", description: "Where Nuclide is thin: unsourced objects, weakly linked objects, indications without pipelines, targets without drugs, and good first records for newcomers. Claim one and fix it.", path: "/gaps/" });
  ...
  return (
    <>
      ...
      <Container className="pb-16">
        ...
        <Gap title="Weakly connected objects" intro="Two or fewer connections. Link to indications, targets, products, trials, or terms so the object participates in the graph." items={weak} field="related" />
