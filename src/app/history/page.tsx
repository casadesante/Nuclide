...
export const metadata: Metadata = pageMeta({ title: "Recent changes", description: "What changed on which Nuclide record, field by field, from the git history.", path: "/history/" });
                              ...
                              <ul className="space-y-3">
                                {rest.map((r, i) => (
                                  <li key={i} id={r.id} className="scroll-mt-24">
                                    ...
                                    {r.type === "changed" && (
                                      <div className="overflow-x-auto"><table className="nuclide mt-2"><thead><tr><th>Field</th><th>Before</th><th>After</th></tr></thead>
