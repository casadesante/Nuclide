...
export const metadata: Metadata = {
  title: { default: "Nuclide: total information dominance on radiopharmaceuticals", template: "%s · Nuclide" },
  description: "An open, cited knowledge graph of nuclear medicine: every isotope, agent, target, indication, trial, company, institution, pathway and idea, one page per object, linked, with plain-English TL;DRs.",
  metadataBase: new URL("https://nuclide.cc"),
  manifest: "/manifest.webmanifest",
  appleWebApp: { capable: true, title: "Nuclide", statusBarStyle: "default" },
  alternates: { canonical: "https://nuclide.cc/", types: FEED_TYPES },
  applicationName: "Nuclide",
  keywords: ["radiopharmaceuticals", "nuclear medicine", "theranostics", "PET imaging", "SPECT imaging", "isotopes", "clinical trials", "oncology", "knowledge graph", "open data"],
  openGraph: { title: "Nuclide: total information dominance on radiopharmaceuticals", description: "The current state of the art, the history, and what is coming, for radiopharmaceutical therapy and diagnostic imaging.", type: "website", siteName: "Nuclide", locale: "en_GB", url: "https://nuclide.cc/" },
  twitter: { card: "summary_large_image", title: "Nuclide: total information dominance on radiopharmaceuticals", description: "The current state of the art, the history, and what is coming, for radiopharmaceutical therapy and diagnostic imaging." },
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" suppressHydrationWarning className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col">
        ...
        <WebMCP />
        <ExternalLinks />
        {/* Record pages stamp data-nuclide-id / data-nuclide-kind on this element for agents (MachineLinks); the hydration warning is for those attributes. */}
