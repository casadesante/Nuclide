...
export default function QueryPage() {
  ...
  return (
    <>
      <PageHeader kicker={<GroupKicker id="find" />} title="Query" lede="Ask structured questions of the corpus: which targets have an approved ADC but no PET tracer, which indications have no phase-3 product, which companies have products but no institutional link. Combine clauses, negate any of them, and get a linked table." />
