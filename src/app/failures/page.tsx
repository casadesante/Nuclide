  ...
  return (
    <>
      <PageHeader kicker={<GroupKicker id="intel" />} title="Failure museum"
        lede="The field learns more from what did not work than from what did, but failures vanish from pipelines and press releases. This room keeps them: drugs stopped, targets abandoned, approvals withdrawn, each with the lesson it left. Nothing here is a verdict on the idea; several of these targets later worked with a different weapon." />
