  ...
  return (
    <>
      <PageHeader kicker={<GroupKicker id="intel" />} title="Evidence"
        lede="Every trial in Nuclide ranked by a disclosed evidence-strength score, with its primary endpoint drawn as people out of 100 or as median months. The score measures how much and what kind of evidence exists, not how large the benefit is." />
