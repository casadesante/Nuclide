...
export const metadata: Metadata = pageMeta({ title: "Trial leadership", description: "Which institutions and cooperative groups are attached to the pivotal trials, products, and technologies in Nuclide.", path: "/leadership/" });
