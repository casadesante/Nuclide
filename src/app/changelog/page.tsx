...
export const metadata: Metadata = pageMeta({ title: "Changelog", description: "What changed in Nuclide, release by release.", path: "/changelog/" });
  ...
  return (
    <>
      ...
      <Container className="pb-16 max-w-3xl">
        <div className="prose-nuclide text-[15px] leading-relaxed">
          {blocks.map((b, i) => {
        ...
        <p className="text-sm text-muted mt-10">Source: <a className="underline" href="https://github.com/casadesante/Nuclide/blob/main/CHANGELOG.md" rel="noopener">CHANGELOG.md</a> · commit history on <a className="underline" href="https://github.com/casadesante/Nuclide/commits/main" rel="noopener">GitHub</a>.</p>
      </Container>
    </>
  );
}
