...
export const metadata: Metadata = pageMeta({ title: "Molecule gallery", description: "Every product in Nuclide with a 3D structure, as rotating wireframes: filter by modality, payload class, target and approval status, open any one in the viewer, and see which products still need a structure.", path: "/molecules/" });
