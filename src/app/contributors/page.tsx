...
export const metadata: Metadata = pageMeta({ title: "Contributors", description: "Everyone who has written or reviewed Nuclide records: commits, records touched, kinds, first and last contribution, and review sign-offs, computed from the repository history.", path: "/contributors/" });
