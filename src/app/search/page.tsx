...
export const metadata: Metadata = pageMeta({ title: "Search", description: "Search every Nuclide record by name or by meaning: word matches and concept matches, merged, each with the reason it ranked.", path: "/search/" });
