...
describe("terms of use", () => {
  it("renders the key sections with icons, a contents strip and JSON-LD", () => {
    ...
    expect(terms).toContain('"url":"https://nuclide.cc/terms-of-use/"');
  });
  ...
  it("states the substance and leaves the owner's placeholders visible", () => {
    ...
    expect(terms).toContain("github.com/casadesante/Nuclide/issues");
...
describe("privacy policy", () => {
  it("renders the key sections with icons, a contents strip and JSON-LD", () => {
    ...
    expect(privacy).toContain('"url":"https://nuclide.cc/privacy/"');
  });
