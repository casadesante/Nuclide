...
export default function Report2026() {
  ...
  const problems = g.kind("indication").flatMap((c) => c.openProblems.slice(0, 2).map((p) => ({ c, p })));
  ...
  return (
    <>
      ...
      <Container className="pb-16">
        ...
        <p className="text-sm text-muted mt-10">This page is regenerated on every build. Corrections and additions go through the <Link className="underline" href="/gaps/">gaps</Link> list and the <a className="underline" href="https://github.com/casadesante/Nuclide" rel="noopener">repository</a>.</p>
      </Container>
    </>
  );
}
