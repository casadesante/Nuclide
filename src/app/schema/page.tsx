...
export const metadata: Metadata = pageMeta({ title: "Data dictionary", description: "Every kind of Nuclide record, every field, its type, whether it is required, and what it means, with a real example per kind.", path: "/schema/" });
    ...
    <>
      ...
      <Container className="pb-16">
        ...
        <section id="statuses" className="scroll-mt-24">
          ...
          <div className="card overflow-x-auto"><table className="nuclide"><thead><tr><th>Value</th><th>Shown as</th></tr></thead>
...
function FieldTable({ fields }: { fields: FieldDoc[] }) {
  return (
    <div className="card overflow-x-auto">
      <table className="nuclide"><thead><tr><th>Field</th><th>Type</th><th>Required</th><th>Description</th></tr></thead>
        <tbody>
          {fields.map((f) => (
            <tr key={f.name}>
