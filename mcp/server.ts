/**
 * Nuclide MCP server: exposes the corpus to AI assistants over stdio.
 *
 ...
 * Resources: nuclide://kinds/{kind}, nuclide://entity/{id}, nuclide://context/{id}.
...
const server = new McpServer({ name: "nuclide", version: "0.3.0" });
