...
const RELATION_FIELDS = new Set(["related", "indications", "sections", "technologies", "targets", "drugs", "companies", "institutions", "pathways", "terms", "trials", "people", "bottlenecks", "keyPapers", "journals", "dependsOn", "pipeline"]);
...
export function formatAsk(r: AskResult): string {
  ...
  lines.push("", `Method: ${r.method}`, "Nuclide is an orientation tool, not medical advice.");
  return lines.join("\n");
}
