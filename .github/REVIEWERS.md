...
Who checks what before a change to `src/data/` is merged. Names are added as reviewers join; until then the maintainer (@casadesante) reviews everything and says so in the PR.
